 ...
 */
function collectDOMStat(root, _result) {
    ...
    for (let child of root.childNodes) {
        if (child.nodeType === Node.TEXT_NODE) {
            ...
            if (_result.tags[child.tagName] == undefined) {
                _result.tags[child.tagName] = 0;
            }
            _result.tags[child.tagName]++;

            let classes = child.classList;

            for (let className of classes) {
                if (_result.classes[className] == undefined) {
                    _result.classes[className] = 0;
                }
                _result.classes[className]++;
            }
        }
        collectDOMStat(child, _result);
    }
